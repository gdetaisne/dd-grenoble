...
export const metadata: Metadata = (() => {
  ...
  return {
    title: `Déménageur ${city.nameCapitalized} | 5+ Devis Fiables | 0 Spam`,
    description:
      `Dès 280€. Comparez 5+ devis de déménageurs contrôlés à ${city.nameCapitalized}. Dossier anonyme, 0 harcèlement. Recevez vos devis en 48h. 100% gratuit.`,
