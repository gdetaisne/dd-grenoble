...
export const metadata: Metadata = {
  title: `Comparateur Déménageurs ${city.nameCapitalized} | 0 Spam, 5+ Devis`,
  description: `Comparez 5+ devis de déménageurs contrôlés à ${city.nameCapitalized}. Dossier anonyme, tarifs transparents, 0 harcèlement. Dès 280€. Gratuit et sans engagement.`,
  alternates: {
    canonical: getCanonicalUrl("notre-offre"),
  },
  openGraph: {
    title: `Comparateur Déménageurs ${city.nameCapitalized} | 0 Spam, 5+ Devis`,
    description: `Comparez 5+ devis de déménageurs contrôlés. Dossier anonyme, 0 spam. Dès 280€. Gratuit.`,
