...
export const metadata: Metadata = (() => {
  ...
  return {
    title: `Comment Ça Marche | Comparateur Déménageurs ${city.nameCapitalized}`,
    description: `Processus simple en 3 étapes : 1) Créez votre dossier (5 min), 2) Recevez 5+ devis comparables, 3) Choisissez votre déménageur. 0 spam. Gratuit.`,
    alternates: {
      canonical: getCanonicalUrl("comment-ca-marche"),
    },
    openGraph: {
      title: `Comment Ça Marche | Comparateur Déménageurs ${city.nameCapitalized}`,
      description: `3 étapes simples : dossier (5 min) → 5+ devis comparables → choix. 0 spam. Gratuit.`,
