...
export const metadata: Metadata = (() => {
  ...
  return {
    title: `Déménagement ${city.nameCapitalized} | Économique, Standard, Premium`,
    description: `3 formules dès 280€ à ${city.nameCapitalized}. Déménageurs contrôlés, devis comparables, 0 spam. Choisissez la formule adaptée à votre budget. Gratuit.`,
    alternates: {
      canonical: getCanonicalUrl('services'),
    },
    openGraph: {
      title: `Déménagement ${city.nameCapitalized} | Économique, Standard, Premium`,
      description: `3 formules dès 280€. Déménageurs contrôlés, devis comparables, 0 spam. Gratuit.`,
